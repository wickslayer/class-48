...
function setup() {
  ...
  restart1= createSprite(390,260,20,20);
  restart1.addImage(restartIMG);
  restart1.visible=false;
  gameOver= createSprite(390,200,20,20);
...
gameOver.visible=true
restart1.visible=true
//make gameOver and restart1 visible
  //play a music of defeat
...
function summonBullet(){
  ...
  function win(){
    restart1.visible=true
  //add an image of trophy
  //play a sound of victory
  if(mousePressedOver(restart1)){
  restart();
  }
  }
